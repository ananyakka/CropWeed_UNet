...
glob_file_key = "/extend_sda/Ananya_files/Weeding Bot Project/Farm Photos/Labelled Data/Three Class Labels/*.png"
for f in enumerate(glob(glob_file_key)):
	...
	for x_offset in range(0, int(image_size/2), x_incr):
		for y_offset in range(0, int(image_size/2), y_incr):
			...
			i+=1
			fullnewfilename = "/extend_sda/Ananya_files/Weeding Bot Project/Farm Photos/Labelled Data/Resized Three Class Translated/"+newfilename +'_'+'translated'+str(i)+ ".png"
	...
	for ang in angles:
		...
		i+=1
		fullnewfilename = "/extend_sda/Ananya_files/Weeding Bot Project/Farm Photos/Labelled Data/Resized Three Class Rotated/"+newfilename +'_'+'rotated'+str(i)+ ".png"
	...
	fullnewfilename = "/extend_sda/Ananya_files/Weeding Bot Project/Farm Photos/Labelled Data/Resized Three Class Distorted/"+newfilename +'_'+'vertical_wave'+ ".png"
	...
	fullnewfilename = "/extend_sda/Ananya_files/Weeding Bot Project/Farm Photos/Labelled Data/Resized Three Class Distorted/"+newfilename +'_'+'horizontal_wave'+ ".png"
	...
	fullnewfilename = "/extend_sda/Ananya_files/Weeding Bot Project/Farm Photos/Labelled Data/Resized Three Class Distorted/"+newfilename +'_'+'verhor_wave'+ ".png"
	...
	fullnewfilename = "/extend_sda/Ananya_files/Weeding Bot Project/Farm Photos/Labelled Data/Resized Three Class Distorted/"+newfilename +'_'+'concave'+ ".png"
